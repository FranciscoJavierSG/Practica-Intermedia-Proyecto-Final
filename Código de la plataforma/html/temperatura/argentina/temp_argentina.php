...
<body>
    ...
    <div class="todo">
        <div>
            <h1>Temperatura en Argentina</h1>
        </div>
        ...
        <div>
            ...
            <div style="padding: 0; margin: 0;">
                <div style="display: inline-block; margin: 0;">
                    ...
                    <p id="ARG_OF1_T" style="margin: 0; display: inline-block;">0</p>
                    <p style="margin-top: 5px; margin-bottom: 5px; display: inline-block;"> ºC</p>
                </div>

                <div id="chartdiv4" style="padding: 0; margin:0;"></div>
            </div>
        </div>
        ...
        <div>
            ...
            <div style="padding: 0; margin: 0;">
                <div style="display: inline-block; margin: 0;">
                    <p style="margin-top: 5px; margin-bottom: 5px; display: inline-block;">Temperatura: </p>
                    <p id="ARG_OF2_T" style="margin: 0; display: inline-block;">0</p>
                    <p style="margin-top: 5px; margin-bottom: 5px; display: inline-block;"> ºC</p>
                </div>

                <div id="chartdiv5" style="padding: 0; margin:0;"></div>
            </div>
        </div>
        ...
        <div style="margin-bottom: 20px;">
            ...
            <div style="padding: 0; margin: 0;">
                <div style="display: inline-block; margin: 0;">
                    <p style="margin-top: 5px; margin-bottom: 5px; display: inline-block;">Temperatura: </p>
                    <p id="ARG_OF3_T" style="margin: 0; display: inline-block;">0</p>
                    <p style="margin-top: 5px; margin-bottom: 5px; display: inline-block;"> ºC</p>
                </div>

                <div id="chartdiv6" style="padding: 0; margin:0;"></div>
            </div>
