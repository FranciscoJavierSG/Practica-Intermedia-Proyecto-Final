...
function temperatura_diaria($anno, $mes, $dia) {
    $sql = "SELECT UNIX_TIMESTAMP(fecha), mensaje FROM tabla WHERE year(fecha) = $anno AND month(fecha) = $mes AND day(fecha) = $dia AND topic = 'Datco/Chile/Oficina_3/Temperatura' ORDER BY fecha";
    # Cosas importantes: 
...
<script>
    $(function() {
        $('#grafico').highcharts({
            ...
            title: {
                text: 'Temperaturas en la oficina 3 de Chile'
            },
