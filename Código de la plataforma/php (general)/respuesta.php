...
<body>
    ...
    function temperatura_diaria($anno, $mes, $dia) {
        $sql = "SELECT UNIX_TIMESTAMP(fecha), mensaje FROM tabla WHERE year(fecha) = $anno AND month(fecha) = $mes AND day(fecha) = $dia AND topic LIKE '%Temperatura' ORDER BY fecha";
        # Cosas importantes: 
